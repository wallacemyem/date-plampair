    ...
    <div id="main-wrapper">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body collapse show">
                                        ...
                                        <p class="card-text">Approve - the user profile cover image will be "moderated".</p>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            ...
            Stream.reject = function (accountId, accessToken, profileId) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/api/v2/method/manager/app.rejectProfileCover',
            ...
            Stream.approve = function (accountId, accessToken, profileId) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/api/v2/method/manager/app.approveProfileCover',
                    data: 'profileId=' + profileId + "&accessToken=" + accessToken + "&accountId=" + accountId,
                    timeout: 30000,
                    success: function(response) {
