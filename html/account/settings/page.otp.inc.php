                            ...
                            <?php
                                ...
                                if ($accountInfo['otpVerified'] == 1) {
                                    ...
                                    ?>
                                        ...
                                        <button disabled id="send-code" class="red action-button mt-4 hidden" name="commit"><?php echo $LANG['action-send-code']; ?></button>
                                    <?php
                                    ...
                                    ?>
                                        ...
                                        <div class="text-right">
                                            <button disabled id="send-code" class="red action-button mt-4" name="commit" onclick="auth();"><?php echo $LANG['action-send-code']; ?></button>
                                        </div>
                                    <?php
                                }
                            ?>
